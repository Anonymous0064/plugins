...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def do_pm_permit_action(chat_id, event):
        ...
        if PM_WARNS[chat_id] == 5:
            ...
            the_message += "⚡️Powered By [GODHACKERZ_USERBOT](https://github.com/hackelite01/Godhackerz-userbot.git)"
