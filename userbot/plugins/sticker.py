...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "No Name Set Yet, Check @Marcususerbot"
...
async def _(event):
    ...
    file_ext_ns_ion = "@Marcususerbot_Sticker.png"
    ...
    if is_a_s:
        ...
        if userid == 1111847352:
            packshortname = "@Marcususerbot_animated"
        else:
